...
export default class DrawSteelGroup extends DrawSteelActorBase {
  static defineSchema() {
    ...
    schema.traits = new fields.SchemaField({
      ...
      fourth: new fields.StringField({ required: false, blank: true }),
      fifth: new fields.StringField({ required: false, blank: true }),
    })
