...
import { DrawSteelActorSheet } from './sheets/actor-sheet.mjs';
import { DrawSteelItemSheet } from './sheets/item-sheet.mjs';
// Import helper/utility classes and constants.
import { preloadHandlebarsTemplates } from './helpers/templates.mjs';
import { DRAW_STEEL } from './helpers/config.mjs';
...
Hooks.once('init', function () {
  ...
  CONFIG.Actor.dataModels = {
    ...
    environmentalEffect: models.DrawSteelEnvironmentalEffect,
  }
  ...
  Actors.registerSheet('draw-steel-unofficial', DrawSteelActorSheet, {
    makeDefault: true,
    label: 'DRAW_STEEL.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('draw-steel-unofficial', DrawSteelItemSheet, {
    makeDefault: true,
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.drawsteelunofficial.rollItemMacro("${data.uuid}");`;
  ...
  if (!macro) {
    macro = await Macro.create({
      ...
      img: item.img,
      command: command,
      flags: { 'draw-steel-unofficial.itemMacro': true },
    });
  }
